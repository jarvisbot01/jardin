...
public class GamaProductoConfiguration : IEntityTypeConfiguration<GamaProducto>
{
    public void Configure(EntityTypeBuilder<GamaProducto> builder)
    {
        ...
        builder.Property(e => e.Gama).HasMaxLength(50).HasColumnName("gama");
        builder
            .Property(e => e.DescripcionHtml)
            .HasColumnType("text")
            .HasColumnName("descripcion_html");
        builder
            .Property(e => e.DescripcionTexto)
            .HasColumnType("text")
            .HasColumnName("descripcion_texto");
        builder.Property(e => e.Imagen).HasMaxLength(256).HasColumnName("imagen");
    }
}
